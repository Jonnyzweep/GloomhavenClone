...
public class hexgame
{
  private hexgame() {
	...
	final static int XSIZE = 10; //board size.
	final static int YSIZE = 7; //board size.
	final static int HEXSIZE = 60;	//hex size in pixels
	final static int BORDERS = 15;
	final static int SCRSIZE = HEXSIZE * (XSIZE + 1) + BORDERS*3; //screen size (vertical dimension).
